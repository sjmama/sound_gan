...
def main(args):
    ...
    if output_folder is None:
        output_folder = f'generated_samples/vacum'
    ...
    param_fp = f'/mnt/HDD/unagan/scripts/checkpoints/save/20240325_043950/model/params.Generator.best_Convergence.torch'
    mean_fp = f'models/{data_type}/mean.mel.npy'
    mean_fp = f'/mnt/HDD/unagan/scripts/training_data/exp_data/mean.mel.npy'
    std_fp = f'models/{data_type}/std.mel.npy'
    std_fp = f'/mnt/HDD/unagan/scripts/training_data/exp_data/std.mel.npy'
    ...
    # ### Vocoder info ###
    vocoder_dir = f'/mnt/HDD/unagan/models/vacum/vocoder'
    ...
    # ### Vocoder ###
    vocoder_model_dir = f'/mnt/HDD/unagan/models/vacum/vocoder'
    sys.path.append(vocoder_model_dir)
    import modules
    # if data_type == 'speech':
    #     vocoder_name = 'OriginalGenerator'
    # else:
    vocoder_name = 'Generator'
